                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="rfvMamh" runat="server" ControlToValidate="txtMamh" 
                                    ErrorMessage="Mã môn học không được để trống" ForeColor="Red" Display="Dynamic">*</asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                                <label>Tên môn</label>
                                ...
                                <asp:RequiredFieldValidator ID="rfvTenmh" runat="server" ControlToValidate="txtTenmh" 
                                    ErrorMessage="Tên môn học không được để trống" ForeColor="Red" Display="Dynamic">*</asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                                <label>Số tiết</label>
                                ...
                                <asp:RequiredFieldValidator ID="rfvSotiet" runat="server" ControlToValidate="txtsotiet" 
                                    ErrorMessage="Số tiết không được để trống" ForeColor="Red" Display="Dynamic">*</asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="revSotiet" runat="server" ControlToValidate="txtsotiet" 
                                    ValidationExpression="^[0-9]+$" ErrorMessage="Số tiết phải là số nguyên dương" ForeColor="Red" Display="Dynamic">*</asp:RegularExpressionValidator>
                            </div>
                            <div class="form-group">
